...
import { KeyframeCreator } from './keyframes-strategy'
...
export class ClipCreator {
	...
	static createClip( config: CamAnimConfig | ModelAnimConfig ): AnimationClip {
		
		this.keyframeCreator.setStrategy( config.keyframeStrategy );
